...
public partial class GestionPharmacieBdContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.IdClient).HasName("PK__Client__6EC2B6C00D634DAC");
        ...
        {
            entity.HasKey(e => e.IdCommande).HasName("PK__Commande__385131BF6E5B6B96");
        ...
        {
            entity.HasKey(e => e.Cin).HasName("PK__Compte__C1F8DC571C636B44");
        ...
        {
            entity.HasKey(e => e.IdFacture).HasName("PK__Facture__6C08ED57665F06EE");
        ...
        {
            entity.HasKey(e => e.IdFournisseur).HasName("PK__Fourniss__5B874F94CADDE8AA");
        ...
        {
            entity.HasKey(e => e.IdPharmacien).HasName("PK__Pharmaci__05C3D25D7013AAF1");
        ...
        {
            entity.HasKey(e => e.Reference).HasName("PK__Produit__FD90DA9864303506");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__ProgFide__3213E83F0716D0F8");
        ...
        {
            entity.HasKey(e => e.IdStock).HasName("PK__Stock__3A39590A62781B76");
        ...
        {
            entity.HasKey(e => e.IdVente).HasName("PK__Vente__459533B30AAC91E5");
