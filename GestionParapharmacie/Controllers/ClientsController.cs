...
using GestionParapharmacie.Models;
...
namespace GestionParapharmacie.Controllers
{
    ...
    public class ClientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Cin,IdClient")] Client client)
        {
            ...
            ViewData["Cin"] = new SelectList(_context.Comptes, "Cin", "Cin", client.Cin);
            return View(client);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Cin,IdClient")] Client client)
        {
